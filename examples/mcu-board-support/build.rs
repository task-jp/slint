...
fn main() -> std::io::Result<()> {
    ...
    cfg_if::cfg_if! {
        ...
        } else if #[cfg(feature = "waveshare-rp2040-touch-lcd-1-69")] {
            board_config_path = Some([env!("CARGO_MANIFEST_DIR"), "waveshare_rp2040_touch_lcd_1_69", "board_config.toml"].iter().collect());
